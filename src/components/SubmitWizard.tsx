...
export function SubmitWizard({ mode = 'create', appId, initialData }: SubmitWizardProps) {
  ...
  useEffect(() => {
    if (watchedUrl && watchedUrl.startsWith('https://')) {
      ...
      const isCustomImage = currentImageUrl && !isAutoGeneratedImage(currentImageUrl);
      if (!isCustomImage) {
        form.setValue('image_url', getPreviewUrl(watchedUrl));
      }
    }
  }, [watchedUrl, form, currentImageUrl]);
                ...
                {form.watch('url') && form.watch('url').startsWith('https://') && (
                  <div className="space-y-3 p-4 rounded-lg bg-muted/50 border border-border">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Klicka "Hämta bild" för att använda denna som appens thumbnail. Du kan byta till egen bild i steg 3.
                    </p>
                  </div>
                )}
